...
ADMIN_USERNAME = "@sugreffsupport"  # Имя администратора для контакта
# =======================
...
TEXTS = {
    "start": (
        ...
        "Чтобы выиграть крутые призы от Сугревъ, нужно:\n"
        "1️⃣ *Оставить отзыв* на товар Маркетплейсе\n"
        "2️⃣ *Отправить скриншот* отзыва в этот чат\n"
        "3️⃣ *Подписаться* на [наш канал]({channel_link})\n\n"
        f"❓ *Вопросы?* Пиши {ADMIN_USERNAME}\n"
    ...
    "subscription_error": (
        ...
        f"Попробуй еще раз через несколько минут или напиши {ADMIN_USERNAME} для помощи."
    ),
